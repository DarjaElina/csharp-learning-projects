...
foreach (string name in studentNames)
{
    ...
    */
    ...
    {
        gradedExamAssignments += 1;

        if (gradedExamAssignments <= examAssignments)
        {
        ...
        {
          gradedExtraCreditAssignmets += 1;
          sumExtraCreditAssignmentScores += score;
        }
    }

    decimal extraCreditPercentage = (decimal)sumExtraCreditAssignmentScores / 10;
    
    currentStudentExamScore = (decimal)(sumExamAssignmentScores) / examAssignments;
    currentStudentExtraCreditScore = sumExtraCreditAssignmentScores / gradedExtraCreditAssignmets;
    currentStudentOverallGrade = ((decimal)(extraCreditPercentage) + sumExamAssignmentScores) / examAssignments;
    currentStudentExtraCreditPoints = (decimal)(extraCreditPercentage) / examAssignments;
